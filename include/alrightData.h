...
class headerField {
 public:
  explicit headerField(std::string aName, std::string aValue)
      : name(aName)
      , value(aValue) {}
 private:
  std::string name;
...
class serverEndpointData {
 public:
  explicit serverEndpointData(unsigned int aPortNumber, std::string aServerPath)
...
class clientEndpointData {
 public:
  explicit clientEndpointData(unsigned int aPN,
                              std::string aAddress,
                              std::string aRequestMethod,
                              std::string aRequestURI,
